      ...
      <form name="registerFrm">
         ...
         <hr class="divider">
            ...
            <div id="divId" class="formDiv">
               ...
               <input type="text" name="id" id="id" class="register-input" placeholder="아이디를 입력해주세요" />
            ...
            <div id="divPwd" class="formDiv">
               ...
               <input type="password" name="pwd" id="pwd" class="register-input" placeholder="비밀번호를 입력해주세요" />
            ...
            <div id="divPwdCheck" class="formDiv">
               ...
               <input type="password" id="pwdCheck" class="register-input" placeholder="비밀번호를 한번 더 입력해주세요" />
               <span class="error">비밀번호가 일치하지 않습니다.</span>
            </div>
         
            <div id="divName" class="formDiv">
               <span>이름<span class="star">*</span></span>
               <input type="text" name="name" id="name" class="register-input" placeholder="이름을 입력해주세요" />
            ...
            <div id="divEmail" class="formDiv">
               ...
               <input type="text" name="email" id="email" class="register-input" placeholder="예: hongkd@naver.com" />
            ...
            <div id="divMobile" class="formDiv">
               ...
               <input type="text" name="mobile" id="mobile" class="register-input" placeholder="숫자만 입력해주세요" />
               <span class="error">숫자만 입력해주세요.</span>
            </div>
            
            <div id="divPostcode" class="formDiv">
               <span>우편번호<span class="star">*</span></span>
               <input type="text" name="postcode" id="postcode" class="address-input" placeholder="우편번호" />
               <%-- 우편번호 찾기 --%>
            ...
            <div id="divAddress" class="formDiv">
               ...
               <input type="text" name="address" id="address" class="register-input" size="40" maxlength="200" placeholder="주소" /><br>      
            </div>
            
            <div id="divAddress" class="formDiv">
            	<span>상세주소<span class="star">*</span></span>
               <input type="text" name="detailaddress" id="detailAddress" class="address-input" size="40" maxlength="200" placeholder="상세주소" />&nbsp;
               <input type="text" name="extraaddress" id="extraAddress" class="address-input" size="40" maxlength="200" placeholder="참고항목" />  
		...
		<div id="agreement-section">
		    ...
		    <div>
		        ...
		        <label>
		            <input type="checkbox" name="agreeAge" />
